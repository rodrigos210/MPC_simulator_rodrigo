...
# MPC Parameters
dt_mpc = 1
t_horizon = 13 # Prediction Horizon = t_horizon / dt_mpc #13
...
def simulation():
    controller = MPCController(t_horizon, c_horizon, mass, I, dx, dy, dt_mpc, Q, R, P, u_min, u_max, x_obs, r_obs, rho, sigma, r_spacecraft)
