...
def main():
    ...
    body = plt.Circle((x_obstacle[0], x_obstacle[1]), r_obstacle/2, color='#303030', fill=True)
    circle = plt.Circle((x_obstacle[0], x_obstacle[1]), r_obstacle, color='#B7B6B6', linestyle='dotted' , fill=True)
